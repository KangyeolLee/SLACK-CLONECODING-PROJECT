...
const Workspace: VFC = () => {
  ...
  const toggleWorkspacModal = useCallback(() => {
  ...
  return (
    <div>
          ...
          <span onClick={onClickUserProfile}>
            ...
            {showUserMenu && (
              ...
              >
                <ProfileModal>
                  <img
                    src={gravatar.url(userData.email, { s: '38px', d: 'retro' })}
                    alt={userData.nickname}
                  />
                  <div>
      ...
      <WorkspaceWrapper>
        ...
        <Channels>
          <WorkspaceName onClick={toggleWorkspacModal}>Sleact</WorkspaceName>
          <MenuScroll>
            <Menu
              show={showWorkspaceModal}
              onCloseModal={toggleWorkspacModal}
